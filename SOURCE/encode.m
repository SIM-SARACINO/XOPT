...
%
%   linked to Gray-code by Simone Saracino
...
if ~isempty(x),
	...
	nround = find(b10-temp>1e-4);	 % Since temp and b10 should contain integers 1e-4 is close enough
	gen = b10to2(b10,bits);		 % Real --> bin
	gen = bin2Gray(gen,bits);	 % bin --> Gray code
