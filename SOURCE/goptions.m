function OPTIONS=goptions(varargin);
...
%	fitness (Default: 0; not normally used).
...
%
%   Based on the original version due to Bill Crossley 07/20/04
...
sizep=length(varargin);
OPTIONS=zeros(1,14);
OPTIONS(1:sizep)=varargin(1:sizep);
default_options=[1,0.9,0,0,0,0,0,0,0,0,30,0.5,0.01,200];
